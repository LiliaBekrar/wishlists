// 📄 Footer.tsx
// 🧠 Rôle : Footer moderne avec gradient et animations
    ...
    <footer className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white mt-auto overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          {/* Copyright avec ton cœur animé */}
          <div className="text-purple-300 text-sm space-y-2">
            <p className="flex items-center justify-center gap-1">
              © {currentYear} {APP_NAME} • Fait avec
              <svg
                className="heart-svg"
                viewBox="0 0 24 24"
                width="22"
          ...
          <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur rounded-full border border-white/20">

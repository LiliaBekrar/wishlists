...
// 📄 ShareModal.tsx - VERSION RESPONSIVE
...
export default function ShareModal({
  ...
  return (
    <>
      {/* ⬅️ Backdrop avec scroll et full viewport */}
      <div
      ...
      >
        {/* ⬅️ Container centré avec padding mobile */}
        <div className="min-h-[100dvh] px-4 py-8 flex items-center justify-center">
          {/* ⬅️ Modal responsive : jamais plus large que l'écran + scroll interne si trop haute */}
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-gray-700">
                      {visibility === 'publique' &&
                        'Tout le monde peut voir et rejoindre cette liste.'}
                      {visibility === 'partagée' &&
                        'Les personnes avec le lien peuvent demander à rejoindre.'}
                      {visibility === 'privée' &&
                        "Les personnes doivent demander l'accès (tu devras approuver)."}
                    </p>
                  </div>
                </div>
              </div>

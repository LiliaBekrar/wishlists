// 📄 Dashboard.tsx
// 🧠 Rôle : Dashboard utilisateur moderne avec gradient
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-3">
            ...
            <span className="ml-3 animate-swing">👋</span>
          </h1>
        ...
        <div className="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            {/* CTA Button */}
            <button
              className={`group relative inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 text-white text-lg font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-purple-500/50 transition-all hover:scale-105 ${FOCUS_RING}`}
            >
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              {[
                ...
                { icon: '🔒', title: 'Privé', desc: 'Partage uniquement avec tes proches' },
                { icon: '💰', title: 'Budget', desc: 'Gère tes dépenses facilement' }
              ].map((feature, i) => (
                <div key={i} className="group bg-gradient-to-br from-white/50 to-white/30 backdrop-blur rounded-xl p-6 border border-gray-200/50 hover:border-purple-300 hover:shadow-lg transition-all">
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Astuce du jour</h3>

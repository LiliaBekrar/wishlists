        ...
        {memberWishlists.map((member) => {
          ...
          return (
            <div
              ...
              className="bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-gray-100"
            >
              {/* Bannière thème */}
              <div
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Tu es <span className="font-semibold">Membre</span> de
                  cette liste.
                </p>

                <button
                  onClick={() => navigate(`/list/${wl.slug}`)}
                  className={`w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg text-sm transition-all ${FOCUS_RING}`}
                >
                  👁️ Voir la liste
                </button>
              </div>
